...
const PageShell = ({ children }: PageShellProps) => (
  <main className="flex-1">
    <div className="w-full px-6 lg:px-8 pt-3 sm:pt-8 pb-20 md:pl-[var(--desktop-nav-offset)] md:grid md:grid-cols-[var(--desktop-nav-current-width)_minmax(0,1fr)] md:gap-8">
      <aside
