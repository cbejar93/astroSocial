...
const MAX_IMAGES = 4;
const LOUNGE_EDITOR_MODULES = {
  toolbar: [["bold", "italic"], [{ list: "bullet" }, { list: "ordered" }]],
};
const LOUNGE_EDITOR_FORMATS = ["bold", "italic", "list"];
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <ReactQuill
              ...
              value={body}
              onChange={setBody}
              modules={LOUNGE_EDITOR_MODULES}
              formats={LOUNGE_EDITOR_FORMATS}
              className="lounge-editor"
            />
          </div>
          <div>
            <label
