      ...
      <div className="w-full max-w-3xl px-0 sm:px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label
              htmlFor="post-images"
              className="flex flex-col items-center justify-center border-2 border-dashed border-gray-600 hover:border-teal-400 p-6 rounded-lg cursor-pointer bg-gray-700 hover:bg-gray-600 transition text-gray-200"
            >
